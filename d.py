...
if NationaliteList[0] == "France":
    if ValuesList[0] == "Prêt":
        api.update_status(media_ids=[media.media_id], status="\U0001F534 OFFICIEL \U0001F534 \n\n" + "\U0001F1EB\U0001F1F7 " + PlayersList[1] + " (" + PosteList[0] + " " + "de " + AgeList[0] + " ans)" + " est prêté à/au " + VersList[3] + " (" + LigueList[0] + ") jusqu'au " + ContratList[1] + " en provenance de/du "+ DeList[1] + " (" + LigueList2[0] + ")" + " !\n\n\U000027A1 https://www.transfermarkt.fr" + LienList[0])
        print("Tweet envoyé !")
    elif ValuesList[0] == "?":
        api.update_status(media_ids=[media.media_id], status = "\U0001F534 OFFICIEL \U0001F534 \n\n" + "\U0001F1EB\U0001F1F7 " + PlayersList[1] + " (" + PosteList[0] + " " + "de " + AgeList[0] + " ans)" + " est transféré à/au " + VersList[3] + " (" +LigueList[0] + ")" + " en provenance du/de " + DeList[1] + " (" + LigueList2[0] + ")" + " pour un montant inconnu !\n\n\U000027A1 https://www.transfermarkt.fr" + LienList[0])
        print("Tweet envoyé !")
        ...
        api.update_status(media_ids=[media.media_id], status="\U0001F534 OFFICIEL \U0001F534 \n\n" + "\U0001F1EB\U0001F1F7 " + PlayersList[1] + " (" + PosteList[0] + " " + "de " + AgeList[0] + " ans)" + " est transféré à/au " + VersList[3] + " (" + LigueList[0] + ")" + " en provenance du/de " + DeList[1] + " (" + LigueList2[0] + ")" + " pour " + ValuesList[0] + " !\n\n\U000027A1 https://www.transfermarkt.fr" + LienList[0])
        print("Tweet envoyé !")
elif NationaliteList[0] == "Turquie":
    if ValuesList[0] == "Prêt":
        api.update_status(media_ids=[media.media_id],status="\U0001F534 OFFICIEL \U0001F534 \n\n" + "\U0001F1F9\U0001F1F7 " + PlayersList[1] + " (" + PosteList[0] + " " + "de " + AgeList[0] + " ans)" + " est prêté à/au " + VersList[3] + " (" + LigueList[0] + ") jusqu'au " + ContratList[1] + " en provenance du/de " + DeList[1] + " (" + LigueList2[0] + ")" + " !\n\n\U000027A1 https://www.transfermarkt.fr" + LienList[0])
        print("Tweet envoyé !")
    elif ValuesList[0] == "?":
        api.update_status(media_ids=[media.media_id], status="\U0001F534 OFFICIEL \U0001F534 \n\n" + "\U0001F1F9\U0001F1F7 " + PlayersList[1] + " (" + PosteList[0] + " " + "de " + AgeList[0] + " ans)" + " est transféré à/au " + VersList[3] + " (" + LigueList[0] + ")" + " en provenance du/de " + DeList[1] + " (" + LigueList2[0] + ")" + " pour un montant inconnu !\n\n\U000027A1 https://www.transfermarkt.fr" + LienList[0])
        print("Tweet envoyé !")
    elif ValuesList[0] == "Transfert libre":
        api.update_status(media_ids=[media.media_id], status="\U0001F534 OFFICIEL \U0001F534 \n\n" + "\U0001F1F9\U0001F1F7 " + PlayersList[1] + " (" + PosteList[0] + " " + "de " + AgeList[0] + " ans)" + " est transféré à/au " + VersList[3] + " (" + LigueList[0] + ")" + " en provenance du/de " + DeList[1] + " (" + LigueList2[0] + ")" + " pour un montant inconnu !\n\n\U000027A1 https://www.transfermarkt.fr" + LienList[0])
        print("Tweet envoyé !")
        ...
        api.update_status(media_ids=[media.media_id], status="\U0001F534 OFFICIEL \U0001F534 \n\n" + "\U0001F1F9\U0001F1F7 " + PlayersList[1] + " (" + PosteList[0] + " " + "de " + AgeList[0] + " ans)" + " est transféré à/au " + VersList[3] + " (" + LigueList[0] + ")" + " en provenance du/de " + DeList[1] + " (" + LigueList2[0] + ")" + " pour " + ValuesList[0] + " !\n\n\U000027A1 https://www.transfermarkt.fr" + LienList[0])
        print("Tweet envoyé !")
else:
    if ValuesList[0] == "Prêt":
        api.update_status(media_ids=[media.media_id], status="\U0001F534 OFFICIEL \U0001F534 \n\n" + PlayersList[1] + " (" + PosteList[0] + " " + "de " + AgeList[0] + " ans)" + " est prêté à/au " + VersList[3] + " (" + LigueList[0] + ") jusqu'au " + ContratList[1] + " en provenance du/de "+ DeList[1] + " (" + LigueList2[0] + ")" + " !\n\n\U000027A1 https://www.transfermarkt.fr" + LienList[0])
        print("Tweet envoyé !")
    elif ValuesList[0] == "?":
        api.update_status(media_ids=[media.media_id], status = "\U0001F534 OFFICIEL \U0001F534 \n\n" + PlayersList[1] + " (" + PosteList[0] + " " + "de " + AgeList[0] + " ans)" + " est transféré à/au " + VersList[3] + " (" +LigueList[0] + ")" + " en provenance du/de " + DeList[1] + " (" + LigueList2[0] + ")" + " pour un montant inconnu !\n\n\U000027A1 https://www.transfermarkt.fr" + LienList[0])
        print("Tweet envoyé !")
    elif ValuesList[0] == "Transfert libre":
        api.update_status(media_ids=[media.media_id], status = "\U0001F534 OFFICIEL \U0001F534 \n\n" + PlayersList[1] + " (" + PosteList[0] + " " + "de " + AgeList[0] + " ans)" + " est transféré à/au " + VersList[3] + " (" +LigueList[0] + ")" + " en provenance du/de " + DeList[1] + " (" + LigueList2[0] + ")" + " pour un montant inconnu !\n\n\U000027A1 https://www.transfermarkt.fr" + LienList[0])
        print("Tweet envoyé !")
        ...
        api.update_status(media_ids=[media.media_id], status="\U0001F534 OFFICIEL \U0001F534 \n\n" + PlayersList[1] + " (" + PosteList[0] + " " + "de " + AgeList[0] + " ans)" + " est transféré à/au " + VersList[3] + " (" + LigueList[0] + ")" + " en provenance du/de " + DeList[1] + " (" + LigueList2[0] + ")" + " pour " +ValuesList[0] + " !\n\n\U000027A1 https://www.transfermarkt.fr" + LienList[0])
        print("Tweet envoyé !")
